...
export const STRINGS = {
  ...
  aria_scan_barcode: 'Scan barcode',
  toast_scanning_barcode: 'Reading barcode…',
  toast_barcode_not_found: "That barcode isn't in Open Food Facts yet — try search instead.",
  toast_barcode_incomplete: "Found it, but nutrition info isn't filled in yet — try search instead.",
  prompt_manual_barcode: 'Enter the barcode number:',
